...
public class SPRCOM_105500_Android_LoginAO_AddpaymentMethod extends MainBase {
    ...
    @Test(groups = {"LoginAO_Payment"}, priority = 11)
    ...
    public void SPRCOM_105506() throws Exception
    {
        SPRCOM_105506_Step1();
        SPRCOM_105506_Step2();
        SPRCOM_105506_Step3();
    ...
    private void SPRCOM_105506_Step1()
    {
    ...
    private void SPRCOM_105506_Step2()
    {
    ...
    private void SPRCOM_105506_Step3()
    {
    ...
    private void SPRCOM_105506_Step4()
    {
    ...
    private void SPRCOM_105506_Step5()
    {
    ...
    private void SPRCOM_105506_Step6() throws Exception
    {
    ...
    private void SPRCOM_105506_Step7()
    {
        saveTextLog_Allure_er("Back to payment page");
    ...
    private void SPRCOM_105506_Step8() throws Exception
    {
